<template>
  <div class="relative">
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-50 absolute top-full left-0 min-w-60 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1">
        <ul
          ref="dropdown"
