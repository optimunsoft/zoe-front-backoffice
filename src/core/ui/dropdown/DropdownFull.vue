<template>
  <div class="relative inline-flex w-full">
    ...
    >
      <div v-show="dropdownOpen" class="z-50 absolute top-full left-0 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1">
        <div
          ref="dropdown"
